    ...
    return(
        <AlignedBox sx={{ mx: 3}}>
            ...
            <AlignedBox marginl="auto">
                ...
                <Link to={toggle === "http://localhost:3000/list" ? "../" : "./list"} onClick={onClick} style={{textDecoration:'inherit' , color:'inherit'}}><NotionFreeButton>Notion 무료 체험</NotionFreeButton></Link>
